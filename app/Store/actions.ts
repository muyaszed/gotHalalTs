...
export default {
  ...
  SET_RESTAURANT_MAP_MODAL_VISIBLE: 'SET_RESTAURANT_MAP_MODAL_VISIBLE' as const,
  SET_USE_GOOGLE_MAP: 'SET_USE_GOOGLE_MAP' as const,
  SET_REVIEW_IMAGE: 'SET_REVIEW_IMAGE' as const,
  SET_REVIEW_SUBMIT_BUTTON_STATUS: 'SET_REVIEW_SUBMIT_BUTTON_STATUS' as const,
  SET_VERIFICATION_DATA: 'SET_VERIFICATION_DATA' as const,
  SET_RESTAURANT_VERIFICATION_MODAL_VISIBLE: 'SET_RESTAURANT_VERIFICATION_MODAL_VISIBLE' as const,
  SET_SHOW_REVIEW_FORM: 'SET_SHOW_REVIEW_FORM' as const,
  SET_REVIEW_CANCEL_MODAL_VISIBLE: 'SET_REVIEW_CANCEL_MODAL_VISIBLE' as const,
};
